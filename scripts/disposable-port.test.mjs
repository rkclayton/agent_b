...
const installer = await readFile(new URL("scripts/test-installer.ps1", root), "utf8");
...
test("every scenario runner refuses production's port", async () => {
  for (const name of [
    ...
    "scripts/navigation-coordinate-evidence.mjs",
    "scripts/navigation-lifecycle-evidence.mjs",
    "scripts/settings-screenshot-gate.mjs",
    "scripts/transcript-fixture-captures.mjs",
  ]) {
