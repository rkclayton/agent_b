...
export function markdown(report) {
  ...
  const lines = [
    ...
    "",
    `Replayed ${report.runs} tapes through \`tests/jsonl-extract.mjs\` and the production \`internal/progress\` evaluators: ${report.passed} passed, ${report.failed} failed. New detectors remained shadow-only.`,
    "",
