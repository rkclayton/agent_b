...
$promptPath = Join-Path $PSScriptRoot 'queue-pointer-prompt.txt'
if (-not (Test-Path -LiteralPath $promptPath)) {
    throw "the pointer prompt is missing: $promptPath"
}
$pointerPrompt = [IO.File]::ReadAllText($promptPath).Trim()
