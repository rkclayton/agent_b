...
try {
    ...
    & (Join-Path (Split-Path -Parent $PSScriptRoot) 'scripts\setup-service-account.ps1') -AccountName $account -CredentialStore $credentialPath -NoPrompt -Confirm:$false
    ...
    & (Join-Path (Split-Path -Parent $PSScriptRoot) 'scripts\setup-service-account.ps1') -AccountName $account -CredentialStore $credentialPath -ValidateCredentialStore
    ...
    $upgradeOutput = (& (Join-Path (Split-Path -Parent $PSScriptRoot) 'scripts\apply-acls.ps1') -AccountName $account -ApplicationDirectory $applicationRoot -DataDirectory $dataRoot -WorkspaceDirectory $workspaceRoot -ExchangeDirectory $exchangeRoot -NoPrompt -Confirm:$false 2>&1 | Out-String)
    ...
    & (Join-Path (Split-Path -Parent $PSScriptRoot) 'scripts\apply-acls.ps1') -AccountName $account -ApplicationDirectory $applicationRoot -DataDirectory $dataRoot -WorkspaceDirectory $workspaceRoot -ExchangeDirectory $exchangeRoot -Verify
    ...
    & (Join-Path (Split-Path -Parent $PSScriptRoot) 'scripts\apply-acls.ps1') -AccountName $account -ApplicationDirectory $applicationRoot -DataDirectory $dataRoot -WorkspaceDirectory $workspaceRoot -ExchangeDirectory $exchangeRoot -NoPrompt -Confirm:$false
