...
# v0.61.0/W6 under r2. Prove tools/sign-release.ps1 signs, timestamps and
...
try {
    ...
    try {
        ...
        & (Get-WindowsPowerShell) -NoLogo -NoProfile -File 'C:\projects\agentb\tools\sign-release.ps1' -Path $stage -Thumbprint $cert.Thumbprint -ReportPath $report 2>&1 | Out-String | Write-Output
