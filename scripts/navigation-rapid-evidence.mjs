...
const model = createServer(async (request, response) => {
  if (request.url === "/props") return void response.end(JSON.stringify({ connection: "navigation-rapid-evidence", n_ctx: 32768 }));
...
const config = {
  ...
  connections: [{ id: "navigation", label: "Navigation", base_url: `http://127.0.0.1:${modelPort}`, model: "navigation-rapid-evidence", credential: "", request_timeout_s: 3, probe_mode: "off",
    ...
    capabilities: { connection: "navigation-rapid-evidence", props: true, n_ctx: 32768, tokenize: true, apply_template: true, apply_template_tools: true, streaming: true, tool_calls: true, grammar_constrained: false, cached_tokens: true, timings: false, prompt_progress: false, document_input: false, image_input: false, reasoning_control: "", valid_efforts: [], overflow_behavior: "error", probed_at: new Date().toISOString(), findings: ["rapid navigation evidence fixture"] } }],
