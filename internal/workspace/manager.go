...
func ParsePolicy(data []byte) (Policy, error) {
	...
	knownTools := map[string]bool{"read_file": true, "list_dir": true, "write_file": true, "edit_file": true, "search_text": true, "shell": true, "remember": true, "recall": true, "fetch_url": true, "web_search": true, "find_files": true, "run_script": true, "call_service": true, "delegate": true}
