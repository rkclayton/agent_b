...
try {
    ...
    if ($_.Exception.Message -notmatch 'PRODUCTION INCARNATION CHANGED.*processes') { throw }
}

Write-Host 'PASS production-incarnation helper records required fields and names a changed field'
